...
if __name__ == "__main__":
  ...
  Test2 = abs(Test2)
  E1 = (10/3) - abs(Test1) #Calculate the difference between the two approximation with the real value
  E2 = (10/3) - abs(Test2)
  print("The value of the two approximations are : ", Test1, Test2)
  print("The error of the two approximations are : ", E1, E2)
